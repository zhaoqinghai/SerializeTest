...
namespace SerializeTest
{
    ...
    public class Test
    {
        ...
        [Benchmark]
        public void SpanJsonSerializeTest()
        {
            var stream = SpanJson.JsonSerializer.Generic.Utf8.Serialize(persons);
        }
        [Benchmark]
        public void SpanJsonTest()
        {
            var stream = SpanJson.JsonSerializer.Generic.Utf8.Serialize(persons);
            SpanJson.JsonSerializer.Generic.Utf8.Deserialize<IEnumerable<Person>>(stream);
        }
